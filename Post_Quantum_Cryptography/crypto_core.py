...
# ============================================================================
# POST-QUANTUM: ML-KEM-512 KEM (formerly Kyber512, NIST FIPS 203)
# HQC-128 replaced with ML-KEM-512 - same Category-1 / 128-bit security level
# ============================================================================

class HQC_KEM:
    """ML-KEM-512 Key Encapsulation Mechanism using liboqs (drop-in replacement for HQC-128)"""
    
    def __init__(self):
        if not HAS_OQS:
            raise RuntimeError("liboqs-python not available - cannot use HQC_KEM")
        self.kem = oqs.KeyEncapsulation("ML-KEM-512")
    ...
    def decapsulate(self, ciphertext: bytes, secret_key: bytes) -> bytes:
        ...
        # Must initialize with the stored secret key — a fresh instance has no key loaded
        kem = oqs.KeyEncapsulation("ML-KEM-512", secret_key=secret_key)
